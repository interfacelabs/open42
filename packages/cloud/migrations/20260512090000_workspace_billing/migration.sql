...
ALTER TABLE "workspaces" ADD COLUMN "billing_plan_key" text DEFAULT 'basic' NOT NULL;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "billing_mode" "workspace_billing_mode" DEFAULT 'platform' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "workspaces" ADD COLUMN "stripe_subscription_status" text;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "stripe_subscription_current_period_start" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "stripe_subscription_current_period_end" timestamp with time zone;--> statement-breakpoint
CREATE UNIQUE INDEX "workspaces_stripe_customer_id_uniq"
  ON "workspaces" ("stripe_customer_id")
  WHERE "stripe_customer_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "workspaces_stripe_subscription_id_uniq"
