 ...
 *
 * Usage:
 *   node packages/cloud/scripts/release-tenant.mjs               # build + push to Docker Hub + Fly
 *   node packages/cloud/scripts/release-tenant.mjs --no-fly      # skip the Fly mirror
 *   node packages/cloud/scripts/release-tenant.mjs --no-build    # skip rebuild, push existing local tag
 *
