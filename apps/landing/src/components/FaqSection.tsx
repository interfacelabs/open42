    ...
    <section className="relative bg-page">
      <div className="page-frame mx-auto w-full max-w-[1320px] px-4 pt-16 pb-16 sm:px-6 md:pt-24 md:pb-24">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-6 max-w-[860px] font-sans text-[34px] font-medium leading-[1.0] text-ink md:text-[56px] md:tracking-[-0.025em]">
            {FAQ.heading}
          </h2>
          ...
          {FAQ.items.map((item, i) => {
            ...
            return (
              <li key={item.q}>
                ...
                >
                  <span className="font-mono text-[15px] text-ink">{item.q}</span>
                  <ChevronDown
                    className={
