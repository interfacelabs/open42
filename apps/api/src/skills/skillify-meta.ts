 ...
 * surface — the generator that consumes this prompt should drop those gates
 * from the contract before validating output. Everything else (schema,
 * triggers, phases, anti-patterns) carries over unchanged.
 */

export const SKILLIFY_SOURCE = {
  upstream: 'gbrain/skills/skillify/SKILL.md',
  upstreamVersion: '0.27.1',
  upstreamSkillVersion: '1.0.0',
  license: 'MIT',
  copyright: 'Copyright (c) 2026 Garry Tan',
} as const;

export const SKILLIFY_META_PROMPT = `---
name: skillify
version: 1.0.0
description: |
